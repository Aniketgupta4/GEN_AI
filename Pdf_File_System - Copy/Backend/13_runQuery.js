...
// =====================================================================
// 13_runQuery.js — INTERACTIVE QUERY CLI (Generic)
// =====================================================================
...
async function startCLI() {
  console.log("===========================================");
  console.log("   🧠 GraphRAG Knowledge Query System");
  console.log("===========================================");
...
// FIX: Agar tu is file ko directly terminal se chalayega (node 13_runQuery.js),
// tabhi CLI start hogi. Agar server.js import karega, toh CLI start nahi hogi.
import url from 'url';
