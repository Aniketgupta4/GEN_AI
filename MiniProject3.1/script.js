...
const ai = new GoogleGenAI({
    // SECURITY FIX: API keys should not be hardcoded in client-side code.
    // In a production environment, load this securely from an environment variable
    // or a backend proxy. For demonstration, replace 'YOUR_GEMINI_API_KEY'
